...
public class InfernumMod implements ModInitializer {
    ...
    public void onInitialize() {
        ...
        // 🌋 Infernal Transformations
        InfernalTransformationHandler.registerDefaultTransformations();

        // ⚔️ Staff + Infernal Knight command attack system
        registerAttackListener();

        // 🌳 Log + Leaf flammability setup
        ...
        LOGGER.info("Infernum Mod initialized successfully 🔥");
    }

    // 🧠 Handles right-click attack commands for Infernal Knights
