package net.ronm19.infernummod.entity.ai.goals.ember_serpent;
...
public class EmberSerpentAttackGoal extends MeleeAttackGoal implements AttackingEntity {
    private final EmberSerpentEntity entity;
    private int attackDelay = 12;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;


    public EmberSerpentAttackGoal( PathAwareEntity mob, double speed, boolean pauseWhenMobIdle ) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((EmberSerpentEntity) mob);
    }
