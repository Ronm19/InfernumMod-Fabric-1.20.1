package net.ronm19.infernummod.entity.ai.goals.inferno_zombie;
...
public class InfernoZombieAttackGoal extends MeleeAttackGoal implements AttackingEntity {
    private final InfernoZombieEntity entity;
    private int attackDelay = 12;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;


    public InfernoZombieAttackGoal( PathAwareEntity mob, double speed, boolean pauseWhenMobIdle ) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((InfernoZombieEntity) mob);
    }
