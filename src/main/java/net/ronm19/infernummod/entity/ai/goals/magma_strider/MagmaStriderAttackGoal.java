package net.ronm19.infernummod.entity.ai.goals.magma_strider;
...
public class MagmaStriderAttackGoal  extends MeleeAttackGoal implements AttackingEntity {
    private final MagmaStriderEntity entity;
    private int attackDelay = 12;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;


    public MagmaStriderAttackGoal( PathAwareEntity mob, double speed, boolean pauseWhenMobIdle ) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((MagmaStriderEntity) mob);
    }
