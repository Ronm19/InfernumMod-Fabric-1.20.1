package net.ronm19.infernummod.entity.ai.goals.volcarnis;
...
public class VolcarnisAttackGoal  extends MeleeAttackGoal implements AttackingEntity {
    private final VolcarnisEntity entity;
    private int attackDelay = 12;
    private int ticksUntilNextAttack = 12;
    private boolean shouldCountTillNextAttack = false;


    public VolcarnisAttackGoal( PathAwareEntity mob, double speed, boolean pauseWhenMobIdle ) {
        super(mob, speed, pauseWhenMobIdle);
        entity = ((VolcarnisEntity) mob);
    }
