package net.ronm19.infernummod.entity.ai.pathing;
...
public class MagmaSpiderNavigation extends MobNavigation {
    @Nullable
    private BlockPos targetPos;

    public MagmaSpiderNavigation( MobEntity mobEntity, World world) {
