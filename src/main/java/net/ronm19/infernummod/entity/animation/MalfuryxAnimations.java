...
public class MalfuryxAnimations {

    public static final Animation MALFURYX_IDLE = Animation.Builder.create(1f).looping()
    ...
    public static final Animation MALFURYX_WALKING = Animation.Builder.create(1f).looping()
            .addBoneAnimation("left_arm",
                    new Transformation(Transformation.Targets.ROTATE,
                            new Keyframe(0f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR),
            ...
            .addBoneAnimation("right_leg",
                    new Transformation(Transformation.Targets.ROTATE,
                            ...
                            new Keyframe(1f, AnimationHelper.createRotationalVector(0f, 0f, 0f),
                                    Transformation.Interpolations.LINEAR))).build();
    public static final Animation MALFURYX_ATTACK = Animation.Builder.create(1f).looping()
