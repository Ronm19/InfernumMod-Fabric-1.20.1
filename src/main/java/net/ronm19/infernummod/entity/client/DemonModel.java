...
public class DemonModel<T extends DemonEntity> extends SinglePartEntityModel<T> {
    ...
    @Override
    public void setAngles(DemonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float headYaw, float headPitch) {
        this.getPart().traverse().forEach(ModelPart :: resetTransform);
        this.setHeadAngles(headYaw, headPitch);

        this.animateMovement(DemonAnimations.DEMON_WALKING, limbSwing, limbSwingAmount, 1.75f, 2.5f);
