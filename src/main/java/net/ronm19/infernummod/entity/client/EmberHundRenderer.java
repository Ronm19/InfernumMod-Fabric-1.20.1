...
public class EmberHundRenderer extends MobEntityRenderer<EmberHundEntity, EmberHundModel<EmberHundEntity>> {
    ...
    public EmberHundRenderer( EntityRendererFactory.Context context) {
        super(context, new EmberHundModel<>(context.getPart(ModModelLayers.EMBER_HUND)), 0.7f);
    }
    ...
    @Override
    public void render( EmberHundEntity livingEntity, float f, float g, MatrixStack matrixStack,
