...
public class FireFishRenderer extends MobEntityRenderer<FireFishEntity, FireFishModel<FireFishEntity>> {
    ...
    public FireFishRenderer( EntityRendererFactory.Context context) {
        ...
        super(context, new FireFishModel<>(context.getPart(ModModelLayers.FIRE_FISH)), 0.2f);
    }
