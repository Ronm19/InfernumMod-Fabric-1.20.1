...
public class ModEntitySpawns {
    public static void addSpawns() {
        ...
        BiomeModifications.addSpawn( context -> context.getBiomeKey().getValue().getNamespace().equals(InfernumMod.MOD_ID),
                SpawnGroup.CREATURE, ModEntities.LAVA_COW, 20, 2, 6);

        BiomeModifications.addSpawn( context -> context.getBiomeKey().getValue().getNamespace().equals(InfernumMod.MOD_ID),
                SpawnGroup.CREATURE, ModEntities.INFERNAL_RABBIT, 20, 2, 6);

        BiomeModifications.addSpawn( context -> context.getBiomeKey().getValue().getNamespace().equals(InfernumMod.MOD_ID),
                SpawnGroup.CREATURE, ModEntities.MAGMA_GOLEM, 20, 2, 6);
        ...
        SpawnRestriction.register(ModEntities.LAVA_COW, SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::canMobSpawn);
        SpawnRestriction.register(ModEntities.INFERNAL_RABBIT, SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::canMobSpawn);
        ...
        SpawnRestriction.register(ModEntities.MAGMA_GOLEM, SpawnRestriction.Location.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, AnimalEntity::canMobSpawn);
